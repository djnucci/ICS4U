...
public class FlashingBall extends MovingObject {
	...
	public FlashingBall(int radius, double x, double y, int left, int right, int top, int bottom){
	...
	public void draw(Graphics g) {
		...
		if (!filledIn) {
			...
			g.fillOval(drawX, drawY + radius / 2, radius * 2, radius);
			g.fillOval(drawX + radius / 2, drawY, radius, radius * 2);
		}
